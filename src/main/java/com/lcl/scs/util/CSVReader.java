...
public class CSVReader {
	...
	public CSVReader(boolean stripMultipleNewlines, char separator, Reader input) {
	...
	public CSVReader(boolean stripMultipleNewlines, char separator, InputStream input)
	...
	public void close() {
	 try {
		...
		LoggingUtilities.generateErrorLog("Unable to release reader");
	}
	}
}
